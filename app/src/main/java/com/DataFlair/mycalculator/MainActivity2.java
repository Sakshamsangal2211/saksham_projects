...
public class MainActivity2 extends AppCompatActivity {
    //    public static final String EXTRA_MESSAGE = "com.DataFlair.mycalculator.EXTRA_MESSAGE";
    public static final String mrp = "com.DataFlair.mycalculator.mrp";
    public static final String tot1 = "com.DataFlair.mycalculator.tot1";


    double in1 = 0, i2 = 0, tot = 0, MRP = 0, c = 1, dis;
    int count = 0;
    int arr[];
    //    double arr[];
    TextView edittext1;
...
//        });
        ...
        button_Equ.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (c == 1) {
                    edittext1.setText("DISCOUNT VALUE PLS");
                    c = 4;
                } else if (c == 4) {
                    edittext1.setText("");
                    c = 2;
                } else if (c == 2) {
                    dis = Float.parseFloat(edittext1.getText() + "");
                    c = 3;
                } else if (c == 3) {
                    ...
                    if (Add) {
//                        tot = tot + (1 - (dis / 100)) * (Float.parseFloat(edittext1.getText() + ""));
...
//
        double tmrp = MRP;
        double tnp = tot;
        b.putDouble(mrp, tmrp);
        b.putDouble(tot1, tnp);
//        intent.putExtras(b);
//
